...
.. list-table::
   ...
   * - ``half_of``
     - ported
     - :meth:`~pybosl2.partitions.Partitionable.half_of` -- any plane; ``cut_path`` /
   ...
   * - ``partition``
     - ported
     - :meth:`~pybosl2.partitions.Partitionable.partition` -- returns the two interlocking pieces
...
API reference
-------------
.. automodule:: pybosl2.partitions
   :members:
   :undoc-members:
   :exclude-members: Partitionable

.. autoclass:: pybosl2.partitions.Partitionable
   :members:
