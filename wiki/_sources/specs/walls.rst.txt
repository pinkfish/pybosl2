    ...
    <div class="spec-panel">
      ...
      <div class="spec-info">
        ...
        <div class="spec-code-wrap">
          ...
          <div class="spec-code" id="code">&gt;&gt;&gt; Walls.sparse_wall(height=50, length=100, thick=4)</div>
        </div>
