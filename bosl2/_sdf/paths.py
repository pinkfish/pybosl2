...
# outlines, Bezier sampling, ...) are NOT duplicated here -- bosl2's own modules are canonical:
# bosl2.paths.Path, bosl2.beziers.Bezier, bosl2.rounding.round_corners, bosl2.shapes2d.egg/supershape
# and bosl2.geometry. Use those directly.
#
