...
# :class:`~bosl2._backend.Solid` -- a Bosl2Solid on the CSG backend, a PyShape on the SDF backend --
...
# the backend's own operators. The backend-specific modules (bosl2.shapes3d, bosl2._sdf) remain
...
# 3-D constructors both the CSG (bosl2.shapes3d) and SDF (bosl2._sdf.shapes3d) backends provide.
_SHARED_3D = (
    "cube",
    "cuboid",
    "cyl",
