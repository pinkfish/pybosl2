...
# ---------------------------------------------------------------------------
# Advanced surface / plot / ruler builders live in bosl2/surfaces3d.py. They are re-exported here
# LAZILY (module __getattr__) so `from bosl2.shapes3d import heightfield` keeps working without an
...
def __getattr__(name):
    ...
    if name in _SURFACE_EXPORTS:
        import bosl2.surfaces3d as _surfaces3d
