...
__all__ = ["Screws", "ThreadPitches", "HexHead", "SocketHead", "ButtonHead",
           "PanHead", "FlatHead", "NutSpec"]
...
_THREAD_ALIAS = {
    "coarse": "coarse", "fine": "fine", "medium": "fine",
    "extra fine": "extra_fine", "extrafine": "extra_fine", "extra-fine": "extra_fine",
    "super fine": "super_fine", "superfine": "super_fine", "super-fine": "super_fine",
}
...
_ISO_THREAD = {
    1: ThreadPitches(0.25, 0.2), 1.2: ThreadPitches(0.25, 0.2), 1.4: ThreadPitches(0.3, 0.2),
    1.6: ThreadPitches(0.35, 0.2), 1.8: ThreadPitches(0.35, 0.2), 2: ThreadPitches(0.4, 0.25),
    2.2: ThreadPitches(0.45, 0.25), 2.5: ThreadPitches(0.45, 0.35), 3: ThreadPitches(0.5, 0.35),
    3.5: ThreadPitches(0.6, 0.35), 4: ThreadPitches(0.7, 0.5), 5: ThreadPitches(0.8, 0.5),
    6: ThreadPitches(1, 0.75), 7: ThreadPitches(1, 0.75), 8: ThreadPitches(1.25, 1, 0.75),
    9: ThreadPitches(1.25, 1, 0.75), 10: ThreadPitches(1.5, 1.25, 1, 0.75),
    11: ThreadPitches(1.5, 1, 0.75), 12: ThreadPitches(1.75, 1.5, 1.25, 1),
    14: ThreadPitches(2, 1.5, 1.25, 1), 16: ThreadPitches(2, 1.5, 1), 18: ThreadPitches(2.5, 2, 1.5, 1),
    20: ThreadPitches(2.5, 2, 1.5, 1), 22: ThreadPitches(2.5, 2, 1.5, 1), 24: ThreadPitches(3, 2, 1.5, 1),
    27: ThreadPitches(3, 2, 1.5, 1), 30: ThreadPitches(3.5, 3, 2, 1.5), 33: ThreadPitches(3.5, 3, 2, 1.5),
    36: ThreadPitches(4, 3, 2, 1.5), 39: ThreadPitches(4, 3, 2, 1.5), 42: ThreadPitches(4.5, 4, 3, 2),
    48: ThreadPitches(5, 4, 3, 2),
}

_HEX_HEAD = {
    5: HexHead(8, 3.5), 6: HexHead(10, 4), 8: HexHead(13, 5.3), 10: HexHead(17, 6.4),
    12: HexHead(19, 7.5), 14: HexHead(22, 8.8), 16: HexHead(24, 10), 18: HexHead(27, 11.5),
    20: HexHead(30, 12.5), 24: HexHead(36, 15), 30: HexHead(46, 18.7),
}

_SOCKET_HEAD = {
    1.6: SocketHead(3, 1.5), 2: SocketHead(3.8, 1.5), 2.5: SocketHead(4.5, 2), 2.6: SocketHead(5, 2),
    3: SocketHead(5.5, 2.5), 3.5: SocketHead(6.2, 2.5), 4: SocketHead(7, 3), 5: SocketHead(8.5, 4),
    6: SocketHead(10, 5), 7: SocketHead(12, 6), 8: SocketHead(13, 6), 10: SocketHead(16, 8),
    12: SocketHead(18, 10), 14: SocketHead(21, 12), 16: SocketHead(24, 14), 18: SocketHead(27, 14),
    20: SocketHead(30, 17), 22: SocketHead(33, 17), 24: SocketHead(36, 19), 27: SocketHead(40, 19),
    30: SocketHead(45, 22), 33: SocketHead(50, 24), 36: SocketHead(54, 27), 42: SocketHead(63, 32),
    48: SocketHead(72, 36),
}

_BUTTON_HEAD = {
    1.6: ButtonHead(2.9, 0.8, 0.9, 0.55), 2: ButtonHead(3.5, 1.3, 1.3, 0.69),
    2.5: ButtonHead(4.6, 1.5, 1.5, 0.87), 3: ButtonHead(5.7, 1.65, 2, 1.04),
    3.5: ButtonHead(5.7, 1.65, 2, 1.21), 4: ButtonHead(7.6, 2.2, 2.5, 1.30),
    5: ButtonHead(9.5, 2.75, 3, 1.56), 6: ButtonHead(10.5, 3.3, 4, 2.08),
    8: ButtonHead(14, 4.4, 5, 2.60), 10: ButtonHead(17.5, 5.5, 6, 3.12),
    12: ButtonHead(21, 6.6, 8, 4.16), 16: ButtonHead(28, 8.8, 10, 5.2),
}

_PAN_HEAD = {
    1.6: PanHead(3.2, 1.3), 2: PanHead(4, 1.6), 2.5: PanHead(5, 2), 3: PanHead(5.6, 2.4),
    3.5: PanHead(7, 3.1), 4: PanHead(8, 3.1), 5: PanHead(9.5, 3.8), 6: PanHead(12, 4.6),
    8: PanHead(16, 6), 10: PanHead(20, 7.5),
}

_FLAT_HEAD = {
    1.6: FlatHead(3.6, 2.85), 2: FlatHead(4.4, 3.65), 2.5: FlatHead(5.5, 4.55), 3: FlatHead(6.3, 5.35),
    3.5: FlatHead(8.2, 7.12), 4: FlatHead(9.4, 8.22), 5: FlatHead(10.4, 9.12), 6: FlatHead(12.6, 11.085),
    8: FlatHead(17.3, 15.585), 10: FlatHead(20, 18.04), 12: FlatHead(24, 21.75), 14: FlatHead(28, 25.25),
    16: FlatHead(32, 28.75), 18: FlatHead(36, 32.2), 20: FlatHead(40, 35.7),
}
...
_NUT = {
    1.6: NutSpec(3.2, 1.3, 1.0, None), 2: NutSpec(4, 1.6, 1.2, None), 2.5: NutSpec(5, 2, 1.6, None),
    3: NutSpec(5.5, 2.4, 1.8, None), 4: NutSpec(7, 3.2, 2.2, None), 5: NutSpec(8, 4.7, 2.7, 5.1),
    6: NutSpec(10, 5.2, 3.2, 5.7), 8: NutSpec(13, 6.8, None, 7.5), 10: NutSpec(16, 8.4, None, 9.3),
    12: NutSpec(18, 10.8, None, 12), 16: NutSpec(24, 14.8, None, 16.4), 20: NutSpec(30, 18, None, 20.3),
    24: NutSpec(36, 21.5, None, 23.9), 30: NutSpec(46, 25.6, None, 28.6), 36: NutSpec(55, 31, None, 34.7),
}
