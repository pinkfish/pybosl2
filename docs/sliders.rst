...
Pure-Python port of BOSL2's ``sliders.scad``: a V-groove :meth:`~pybosl2.sliders.Sliders.slider` and
the matching :meth:`~pybosl2.sliders.Sliders.rail`, both designed to 3-D print without support. Tune
the printed fit with the slider's ``slop``.
.. autoclass:: pybosl2.sliders.Sliders
   :members:
