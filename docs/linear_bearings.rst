...
:meth:`~pybosl2.linear_bearings.LinearBearings.lmXuu_bearing` looks a standard size up in
:meth:`~pybosl2.linear_bearings.LinearBearings.lmXuu_info` (a
:class:`~pybosl2.linear_bearings.LinearBearingSpec` table);
:meth:`~pybosl2.linear_bearings.LinearBearings.linear_bearing` is the generic form.
.. autoclass:: pybosl2.linear_bearings.LinearBearingSpec
   :members:

.. autoclass:: pybosl2.linear_bearings.LinearBearings
   :members:
