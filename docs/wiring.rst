...
:meth:`~pybosl2.wiring.Wiring.wire_bundle` hex-packs a set of round wires into a bundle and sweeps them
...
:meth:`~pybosl2.wiring.Wiring.hex_offsets` exposes the optimal hexagonal packing centres it uses.
.. autoclass:: pybosl2.wiring.Wiring
   :members:
