...
Pure-Python port of BOSL2's ``turtle3d.scad`` as a :class:`~pybosl2.turtle3d.Turtle` class. A turtle
walks through 3-D space carrying an orientation frame; a flat list of commands drives it, and the
result is either the list of points it visited (:meth:`~pybosl2.turtle3d.Turtle.points`) or a list of
4x4 transforms (:meth:`~pybosl2.turtle3d.Turtle.transforms`) ready to sweep a profile with
...
.. autoclass:: pybosl2.turtle3d.Turtle
   :members:
