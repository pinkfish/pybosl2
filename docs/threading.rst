...
Pure-Python port of the core of BOSL2's ``threading.scad``. The :class:`~pybosl2.threading.Threading`
...
Every method is a class method returning a :class:`~pybosl2.shapes3d.Bosl2Solid`::
...
API reference
-------------
.. autoclass:: pybosl2.threading.Threading
   :members:
