...
:meth:`~pybosl2.ball_bearings.BallBearings.ball_bearing` builds one from a trade-size name or explicit
dimensions; :meth:`~pybosl2.ball_bearings.BallBearings.ball_bearing_info` returns the tabulated
dimensions as a :class:`~pybosl2.ball_bearings.BearingSpec`.
.. autoclass:: pybosl2.ball_bearings.BearingSpec
   :members:

.. autoclass:: pybosl2.ball_bearings.BallBearings
   :members:
