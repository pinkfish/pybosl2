    ...
    <div class="spec-panel">
      ...
      <div class="spec-info">
        ...
        <div class="spec-code-wrap">
          ...
          <div class="spec-code" id="code">&gt;&gt;&gt; SpurGear(mod=4, teeth=20, thickness=8, shaft_diam=6).shape()</div>
        </div>
...
.. raw:: html
    ...
    <script id="spec-data" type="application/json">[{"id": "spur", "label": "spur", "uri": "_stl/gears-spur.stl", "code": "SpurGear(mod=4, teeth=20, thickness=8, shaft_diam=6).shape()", "part": "SpurGear(mod=4, teeth=20, thickness=8, shaft_diam=6).shape()", "tris": 5320, "vol": "39,095.6", "bbox": "88\u00d788\u00d78", "wt": true}, {"id": "profile-shift", "label": "profile-shift", "uri": "_stl/gears-profile-shift.stl", "code": "SpurGear(mod=4, teeth=7, thickness=8).shape()", "part": "SpurGear(mod=4, teeth=7, thickness=8).shape()", "tris": 2012, "vol": "6,128.8", "bbox": "39\u00d738\u00d78", "wt": true}, {"id": "helical", "label": "helical", "uri": "_stl/gears-helical.stl", "code": "SpurGear(mod=4, teeth=20, thickness=8, helical=25, shaft_diam=6).shape()", "part": "SpurGear(mod=4, teeth=20, thickness=8, helical=25, shaft_diam=6).shape()", "tris": 5800, "vol": "47,901.7", "bbox": "96\u00d796\u00d78", "wt": true}, {"id": "herringbone", "label": "herringbone", "uri": "_stl/gears-herringbone.stl", "code": "SpurGear(mod=4, teeth=20, thickness=12, helical=25, herringbone=True, shaft_diam=6).shape()", "part": "SpurGear(mod=4, teeth=20, thickness=12, helical=25, herringbone=True, shaft_diam=6).shape()", "tris": 8700, "vol": "71,880.4", "bbox": "96\u00d796\u00d712", "wt": true}, {"id": "rack", "label": "rack", "uri": "_stl/gears-rack.stl", "code": "Rack(mod=4, teeth=8, thickness=8, height=10).shape()", "part": "Rack(mod=4, teeth=8, thickness=8, height=10).shape()", "tris": 140, "vol": "4,620.4", "bbox": "101\u00d78\u00d710", "wt": true}, {"id": "ring", "label": "ring gear", "uri": "_stl/gears-ring.stl", "code": "RingGear(mod=4, teeth=24, thickness=8, backing=4).shape()", "part": "RingGear(mod=4, teeth=24, thickness=8, backing=4).shape()", "tris": 6856, "vol": "23,015.5", "bbox": "114\u00d7113\u00d78", "wt": true}, {"id": "bevel", "label": "bevel", "uri": "_stl/gears-bevel.stl", "code": "BevelGear(mod=4, teeth=20, face_width=10, pitch_angle=45, shaft_diam=6).shape()", "part": "BevelGear(mod=4, teeth=20, face_width=10, pitch_angle=45, shaft_diam=6).shape()", "tris": 3400, "vol": "36,770.3", "bbox": "85\u00d785\u00d713", "wt": true}, {"id": "worm", "label": "worm", "uri": "_stl/gears-worm.stl", "code": "Worm(mod=4, diameter=30, length=50, starts=1).shape()", "part": "Worm(mod=4, diameter=30, length=50, starts=1).shape()", "tris": 7982, "vol": "36,024.6", "bbox": "38\u00d738\u00d750", "wt": true}]</script>
    <script type="module">
