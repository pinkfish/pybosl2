...
.. raw:: html
    ...
    <div class="spec-panel">
      <div class="spec-draw">
        <div class="spec-caption"><span id="vpart">PhillipsMask(size="#2", l=10).shape()</span><span>interactive &middot; drag to orbit</span></div>
      ...
      <div class="spec-info">
        ...
        <div class="spec-code-wrap">
          ...
          <div class="spec-code" id="code">&gt;&gt;&gt; PhillipsMask(size="#2", l=10).shape()</div>
        </div>
...
.. raw:: html
    ...
    <script id="spec-data" type="application/json">[{"id": "phillips", "label": "Phillips #2", "uri": "../_stl/screw_drive-phillips.stl", "code": "PhillipsMask(size=\"#2\", l=10).shape()", "part": "PhillipsMask(size=\"#2\", l=10).shape()", "tris": 176, "vol": "29.3", "bbox": "6\u00d76\u00d74", "wt": true}, {"id": "hex", "label": "hex 3 mm", "uri": "../_stl/screw_drive-hex.stl", "code": "hex_mask(size=3, l=10)", "part": "hex_mask(size=3, l=10)", "tris": 20, "vol": "80.9", "bbox": "4\u00d73\u00d710", "wt": true}, {"id": "torx", "label": "Torx T30", "uri": "../_stl/screw_drive-torx.stl", "code": "TorxMask(size=30, l=10).shape()", "part": "TorxMask(size=30, l=10).shape()", "tris": 188, "vol": "176.3", "bbox": "6\u00d75\u00d710", "wt": true}, {"id": "robertson", "label": "Robertson #2", "uri": "../_stl/screw_drive-robertson.stl", "code": "RobertsonMask(size=\"#2\", l=10).shape()", "part": "RobertsonMask(size=\"#2\", l=10).shape()", "tris": 74, "vol": "93.4", "bbox": "4\u00d74\u00d710", "wt": true}]</script>
    <script type="module">
