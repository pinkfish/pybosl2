...
Includes the involute :meth:`~pybosl2.gears.Gears.spur_gear2d` / :meth:`~pybosl2.gears.Gears.spur_gear`
(helical and/or ``herringbone``), the internal :meth:`~pybosl2.gears.Gears.ring_gear`, the linear
:meth:`~pybosl2.gears.Gears.rack`, the :meth:`~pybosl2.gears.Gears.bevel_gear`, the
:meth:`~pybosl2.gears.Gears.worm` / :meth:`~pybosl2.gears.Gears.worm_gear` pair, the dimension helpers,
:meth:`~pybosl2.gears.Gears.auto_profile_shift`, and :meth:`~pybosl2.gears.Gears.gear_dist` for the
meshing centre distance.
.. autoclass:: pybosl2.gears.Gears
   :members:
