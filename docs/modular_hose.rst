...
"Loc-Line" style adjustable/coolant hose. :meth:`~pybosl2.modular_hose.ModularHose.modular_hose`
revolves a ball end, a socket end, or a full segment for the 1/4", 1/2" and 3/4" sizes;
:meth:`~pybosl2.modular_hose.ModularHose.modular_hose_radius` gives the bore radius.
.. autoclass:: pybosl2.modular_hose.ModularHose
   :members:
