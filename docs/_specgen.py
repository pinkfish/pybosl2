...
VARIANTS = {
    ...
    "shapes3d": [
        ...
        ("sphere", "sphere", "pybosl2.sphere(r=15)"),
        ("cylinder", "cylinder", "pybosl2.cylinder(h=20, r=8)"),
        ("cone", "cone", "pybosl2.cone(h=20, r1=10, r2=3)"),
        ("prismoid", "prismoid", "pybosl2.prismoid(size1=[20, 20], size2=[10, 10], h=15)"),
        ("torus", "torus", "pybosl2.torus(r=12, r2=4)"),
        ("tube", "tube", "pybosl2.tube(h=20, or_=10, ir=6)"),
        ("teardrop", "teardrop", "pybosl2.teardrop(h=20, r=10)"),
        ("capsule", "capsule", "pybosl2.capsule(h=30, r=6)"),
        (
            "rounded-cuboid",
            "rounded cuboid",
        ...
        (
            "chamfered-cylinder",
            "chamfered cyl",
            "pybosl2.cylinder(h=20, r=10, chamfer=2)",
        ),
        (
            "octahedron",
            "octahedron",
            "pybosl2.octahedron(size=[20, 20, 20])",
        ),
    ],
    "shapes2d": [
        ("circle", "circle", "pybosl2.circle2d(r=15)"),
        ("square", "square", "pybosl2.square2d(30)"),
        ("rect", "rectangle", "pybosl2.rect2d([30, 20], rounding=5)"),
        ...
        (
            "rounded-square",
            "rounded square",
            "pybosl2.square2d(30, rounding=8)",
        ),
    ],
}
