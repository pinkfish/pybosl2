...
#    are no module-level bezier functions, mirroring how pybosl2/paths.py hangs
...
#    a VNF port (pybosl2/vnf.py) and a sweep port (pybosl2/skin.py):
...
class BezierPatch(list):
    ...
    def vnf(self, splinesteps: int = 16, style: str = "default") -> VNF:
        """Mesh this patch into a :class:`~pybosl2.vnf.VNF`. *splinesteps* is a scalar or [u, v]."""
