...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "Shape2D": ("pybosl2.shape2d", "Shape2D"),
    # anchor system
    ...
    "polygon": ("pybosl2.shape2d", "polygon"),
    "rect": ("pybosl2.shape2d", "rect"),
