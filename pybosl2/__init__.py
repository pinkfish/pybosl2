...
#    source:
#      pybosl2/constants.py    <- BOSL2/constants.scad   (pure Python)
#      pybosl2/math.py         <- BOSL2/math.scad         (pure Python)
#      pybosl2/vectors.py      <- BOSL2/vectors.scad      (pure Python)
#      pybosl2/lists.py        <- BOSL2/lists.scad        (pure Python)
#      pybosl2/comparisons.py  <- BOSL2/comparisons.scad  (pure Python)
#      pybosl2/geometry.py     <- BOSL2/geometry.scad     (pure Python, partial)
#      pybosl2/paths.py        <- BOSL2/paths.scad        (pure Python)
#      pybosl2/shapes2d.py     <- BOSL2/shapes2d.scad     (pure Python)
#      pybosl2/shapes3d.py     <- BOSL2/shapes3d.scad     (thin osuse() wrapper)
#
...
#    by submodule (`from pybosl2 import shapes3d`) rather than re-exported
...
#    `from pybosl2 import <pure-python-module>` too.
#
