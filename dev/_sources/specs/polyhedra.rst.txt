...
.. raw:: html
    ...
    <div class="spec-panel">
      <div class="spec-draw">
        <div class="spec-caption"><span id="vpart">RegularPolyhedron.tetrahedron(radius=15).shape</span></div>
...
.. raw:: html
    ...
    <script id="spec-data" type="application/json">[{"id": "tetrahedron", "label": "tetrahedron", "uri": "_stl/polyhedra-tetrahedron.stl", "code": "RegularPolyhedron.tetrahedron(radius=15).shape", "part": "RegularPolyhedron.tetrahedron(radius=15).shape", "tris": 4, "vol": "1,732.1", "bbox": "17\u00d717\u00d717", "wt": true}, {"id": "cube", "label": "cube", "uri": "_stl/polyhedra-cube.stl", "code": "RegularPolyhedron.cube(radius=15).shape", "part": "RegularPolyhedron.cube(radius=15).shape", "tris": 12, "vol": "5,196.2", "bbox": "17\u00d717\u00d717", "wt": true}, {"id": "octahedron", "label": "octahedron", "uri": "_stl/polyhedra-octahedron.stl", "code": "RegularPolyhedron.octahedron(radius=15).shape", "part": "RegularPolyhedron.octahedron(radius=15).shape", "tris": 8, "vol": "4,500.0", "bbox": "30\u00d730\u00d730", "wt": true}, {"id": "dodecahedron", "label": "dodecahedron", "uri": "_stl/polyhedra-dodecahedron.stl", "code": "RegularPolyhedron.dodecahedron(side=12).shape", "part": "RegularPolyhedron.dodecahedron(side=12).shape", "tris": 36, "vol": "13,241.9", "bbox": "31\u00d731\u00d731", "wt": true}, {"id": "icosahedron", "label": "icosahedron", "uri": "_stl/polyhedra-icosahedron.stl", "code": "RegularPolyhedron.icosahedron(radius=15).shape", "part": "RegularPolyhedron.icosahedron(radius=15).shape", "tris": 20, "vol": "8,559.5", "bbox": "26\u00d726\u00d726", "wt": true}]</script>
    <script type="module">
