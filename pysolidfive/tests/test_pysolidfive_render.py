...
#    itself has no pybosl2/numpy dependency (see pysolidfive/__init__.py's module docstring), so
...
#    pybosl2 (and therefore to every *other* library's render tests), not to pysolidfive.
#
