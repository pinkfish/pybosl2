...
_PREAMBLE = (
    ...
    "from pybosl2 import nurbs_curve, nurbs_curve_point, nurbs_patch_points, nurbs_patch_point\n"
    "from pybosl2 import nurbs_vnf, nurbs_elevate_degree, is_nurbs_patch, NurbsType, NurbsCurve\n"
