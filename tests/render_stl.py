...
_PREAMBLE = (
    ...
    "    ThreadedRod, ThreadedNut, ThreadHelix,\n"
    ...
    "    TrussSegment, Truss, TrussCorner, TrussSupport,\n"
    "    TrussClip, TrussFoot, TrussUClip, TrussJoiner, truss_dist,\n"
    ")\n"
    ...
    "from pybosl2.parts.sliders import Slider, Rail\n"
