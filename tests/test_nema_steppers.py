...
from pybosl2.parts.nema_steppers import NemaSpec
from pybosl2.parts.nema_steppers import NemaSteppers as N
...
def test_mount_mask_builds(kw: dict[str, object]) -> None:
    assert isinstance(N.nema_mount_mask(17, **kw), Bosl2Solid)  # type: ignore[arg-type]
