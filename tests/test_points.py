...
class TestPoint:
    ...
    def test_astuple_2d(self):
        assert Point(1, 2).astuple() == (1.0, 2.0)

    def test_astuple_3d(self):
    ...
    def test_to_3d_from_2d(self):
        p = Point(1, 2).to_3d(5.0)
        assert not p.is_2d
        assert p.z == 5.0
        assert p == Point(1, 2, 5)

    def test_to_3d_from_3d(self):
        p = Point(1, 2, 3).to_3d(99.0)
        assert p.z == 99.0


class TestVector:
    def test_3d_arithmetic(self):
        v = Vector([1, 2, 3])
