...
def test_sparse_wall_variants_build():
    ...
    assert isinstance(W.sparse_wall(h=50, l=100, thick=4, maxang=45, max_bridge=30), Bosl2Solid)
...
def test_thinning_triangle_diagonly_builds():
    assert isinstance(W.thinning_triangle(h=50, l=80, thick=4, diagonly=True), Bosl2Solid)
